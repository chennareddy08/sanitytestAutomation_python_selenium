...
email="TestTrainer_user_" + emailstamp + "@gmail.com"
...
class TestTrainerAccount(BaseTestCase):
    ...
    #     user_info = target.generate_random_info()
    ...
    #     target.trainer_account_creation('test1','tester',user_info['email'],'1239988201','12345678','12345678','90405','4','abc','8')
    #
    #
    #
    #
    ...
    def test_createAccount_madatoryfield(self):
        ...
        d13 = self.driver.find_element_by_css_selector(
            '#app-layout > section.apply-flow > div > form > div > div.panel-body > div.alert.alert-danger')
            # app-layout > section > div > form > div > div.panel-body > div.alert.alert-danger
